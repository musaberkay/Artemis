...
describe('TextSubmissionAssessmentComponent', () => {
    ...
    describe('assessor AI Experience opt-in hint', () => {
        ...
        beforeEach(() => {
            ...
            component.exercise = cloneWith(exercise, { course: { ...exercise.course, athenaGradingFeedbackEnabled: true } }) as TextExercise;
        });
        ...
        it('should not require opt-in when Athena grading feedback is not enabled for the course', () => {
            component.exercise = cloneWith(exercise, { course: { ...exercise.course, athenaGradingFeedbackEnabled: false } }) as TextExercise;
            vi.spyOn(aiExperienceOptInService, 'hasAcceptedAiUsage').mockReturnValue(false);
            expect(component.requiresAiExperienceOptIn()).toBe(false);
        });
